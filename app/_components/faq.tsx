...
const ITEMS: { q: string; a: string }[] = [
  ...
  {
    q: '何人から利用できますか？',
    a: '1台につきマウスピースを4つまでお付けします。お1人様からでもご利用いただけます。5名以上のグループの場合は、複数台のご予約をおすすめいたします。',
  },
  {
    q: '予約のキャンセルはできますか？',
    a: 'ご予約の2時間前までであればキャンセル可能です。キャンセルはトップページの「キャンセルはこちら」ボタンからお手続きください。2時間前を過ぎてからのキャンセルはお受けできませんのでご了承ください。',
  },
]
